...
@ComponentScan({"com.aartek.configuration"})//is equivalent to context:component-scan base-package="..." in xml, providing with where to look for spring managed beans/classes.
...
public class HibernateConfiguration {
	...
	@Autowired
	private Environment environment;//use Spring’s Environment to fetch the value corresponding to an item from .properties file.
